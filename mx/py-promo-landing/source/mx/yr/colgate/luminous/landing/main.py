...
__project_full_name__ = u"Y&R, Colgate, Luminous, Landing"
...
from mx.yr.colgate.luminous.landing.handlers import common as CommonHandlers, \
...
define("html_title", default=u"Colgate, Luminous")
...
define("database_ddbb", default="colgate_luminous_landing")
define("database_pool", default="colgate_luminous_landing_pool")
...
define("colgate_domain", default="www.colgateluminouswhite.com.mx")
define("colgate_domain_inc", default="www.colgate.com.mx")
...
class MainApplication(Application):
    ...
    def __init__(self):
        ...
        settings = dict(
            ...
            colgate_domain=options.colgate_domain,
            colgate_domain_inc=options.colgate_domain_inc,)
